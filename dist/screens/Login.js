...
var Login = function Login(props) {
  ...
  function _onClickLogin() {
    _onClickLogin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var email, password, emptyEmail, emptyPassword, validEmail, user, response, JSONnewUsers;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              validEmail = (0, _checkEmailValidation.default)(email); //controllo campi email, password
            ...
            case 17:
              _context.prev = 17;
              JSONnewUsers = JSON.stringify(response.data); // salvo l'utente corrente
              _context.next = 21;
