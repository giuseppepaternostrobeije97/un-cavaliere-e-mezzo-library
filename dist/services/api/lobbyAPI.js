    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _genericServices.postApi)(_apiRoutes.default.lobby);
          case 2:
...
function putLobby(_x) {
  return _putLobby.apply(this, arguments);
}
function _putLobby() {
  _putLobby = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(idLobby) {
